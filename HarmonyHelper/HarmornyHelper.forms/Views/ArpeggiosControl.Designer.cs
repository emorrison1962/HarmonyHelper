namespace HarmornyHelper.forms
{
	partial class ArpeggiosControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._panelNoteViewers = new System.Windows.Forms.Panel();
			...
			// _outputPanel
			// 
			this._outputPanel.Controls.Add(this._panelNoteViewers);
			...
			// _panelNoteViewers
			// 
			this._panelNoteViewers.AutoScroll = true;
			this._panelNoteViewers.BackColor = System.Drawing.SystemColors.Window;
			this._panelNoteViewers.Dock = System.Windows.Forms.DockStyle.Fill;
			this._panelNoteViewers.Location = new System.Drawing.Point(0, 0);
			this._panelNoteViewers.Name = "_panelNoteViewers";
			this._panelNoteViewers.Size = new System.Drawing.Size(620, 309);
			this._panelNoteViewers.TabIndex = 3;
			// 
			// _tbDiags
			// 
            ...
            ((object)(resources.GetObject("_comboKey.Items15"))),
            ((object)(resources.GetObject("_comboKey.Items16"))),
            ((object)(resources.GetObject("_comboKey.Items17"))),
            ((object)(resources.GetObject("_comboKey.Items18"))),
            ((object)(resources.GetObject("_comboKey.Items19"))),
            ((object)(resources.GetObject("_comboKey.Items20"))),
            ((object)(resources.GetObject("_comboKey.Items21"))),
            ((object)(resources.GetObject("_comboKey.Items22"))),
            ((object)(resources.GetObject("_comboKey.Items23"))),
            ((object)(resources.GetObject("_comboKey.Items24"))),
            ((object)(resources.GetObject("_comboKey.Items25"))),
            ((object)(resources.GetObject("_comboKey.Items26"))),
            ((object)(resources.GetObject("_comboKey.Items27"))),
            ((object)(resources.GetObject("_comboKey.Items28"))),
            ((object)(resources.GetObject("_comboKey.Items29"))),
            ((object)(resources.GetObject("_comboKey.Items30"))),
            ((object)(resources.GetObject("_comboKey.Items31"))),
            ((object)(resources.GetObject("_comboKey.Items32"))),
            ((object)(resources.GetObject("_comboKey.Items33"))),
            ((object)(resources.GetObject("_comboKey.Items34"))),
            ((object)(resources.GetObject("_comboKey.Items35"))),
            ((object)(resources.GetObject("_comboKey.Items36"))),
            ((object)(resources.GetObject("_comboKey.Items37"))),
            ((object)(resources.GetObject("_comboKey.Items38"))),
            ((object)(resources.GetObject("_comboKey.Items39"))),
            ((object)(resources.GetObject("_comboKey.Items40"))),
            ((object)(resources.GetObject("_comboKey.Items41"))),
            ((object)(resources.GetObject("_comboKey.Items42"))),
            ((object)(resources.GetObject("_comboKey.Items43"))),
            ((object)(resources.GetObject("_comboKey.Items44")))});
			...
			this._comboKey.Location = new System.Drawing.Point(54, 28);
			this._comboKey.Margin = new System.Windows.Forms.Padding(2);
			this._comboKey.Name = "_comboKey";
			this._comboKey.Size = new System.Drawing.Size(92, 21);
            ...
            "Treble",
            "Bass"});
			this._comboClef.Location = new System.Drawing.Point(54, 52);
			this._comboClef.Margin = new System.Windows.Forms.Padding(2);
			this._comboClef.Name = "_comboClef";
			this._comboClef.Size = new System.Drawing.Size(92, 21);
			...
			// _bnParse
			// 
			this._bnParse.Location = new System.Drawing.Point(883, 71);
		...
		private System.Windows.Forms.Panel _panelNoteViewers;
	}
}
