...
namespace Eric.Morrison.Harmony.Tests
{
	...
	public class ChordFormulaParserTests
	{
		...
		public void Bug_Parse_Bbm7_Test()
		{
			...
			Assert.IsTrue(ChordIntervalsEnum.Minor7 == result.First().ChordType);
...
";
		...
		[TestMethod()]
		public void NoteName_Normalization_Bug_TryParse_Test()
		{
			var problemChildren = @"Fm7";
			var strings = problemChildren.Split(new string[] { ", " }, StringSplitOptions.RemoveEmptyEntries).ToList();
			...
			foreach (var chordStr in strings)
			{
				...
				{
					Assert.Fail("Parsing failed. Why?");
				}
			}
