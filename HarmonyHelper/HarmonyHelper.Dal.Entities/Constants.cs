namespace Eric.Morrison.Harmony
{
    static public class Constants
    {
        ...
        const int INTERVAL_VALUE_UNISON = 1;
        const int INTERVAL_VALUE_MINOR_2ND = 1 << 1;
        const int INTERVAL_VALUE_MAJOR_2ND = 1 << 2;
        const int INTERVAL_VALUE_MINOR_3RD = 1 << 3;
        const int INTERVAL_VALUE_MAJOR_3RD = 1 << 4;
        const int INTERVAL_VALUE_DIMINISHED_4TH = INTERVAL_VALUE_MAJOR_3RD;
        const int INTERVAL_VALUE_PERFECT_4TH = 1 << 5;
        const int INTERVAL_VALUE_AUGMENTED_4TH = 1 << 6;
        const int INTERVAL_VALUE_DIMINISHED_5TH = INTERVAL_VALUE_AUGMENTED_4TH;
        const int INTERVAL_VALUE_PERFECT_5TH = 1 << 7;
        const int INTERVAL_VALUE_AUGMENTED_5TH = 1 << 8;
        const int INTERVAL_VALUE_MINOR_6TH = INTERVAL_VALUE_AUGMENTED_5TH;
        const int INTERVAL_VALUE_MAJOR_6TH = 1 << 9;
        const int INTERVAL_VALUE_MINOR_7TH = 1 << 10;
        const int INTERVAL_VALUE_MAJOR_7TH = 1 << 11;
        const int INTERVAL_VALUE_PERFECT_OCTAVE = 1 << 12;
