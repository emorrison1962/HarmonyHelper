...
{
	public abstract class ScaleFormulaBase : IComparable<ScaleFormulaBase>, IEquatable<ScaleFormulaBase>, INoteNameContainer, IHasRootNoteName
	{
		...
		virtual protected void PopulateNoteNames()
		{
			...
			{
                var nn = NoteName.TransposeUp(this.Root, interval, true);
