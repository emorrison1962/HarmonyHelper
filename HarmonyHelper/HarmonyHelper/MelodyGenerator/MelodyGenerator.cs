...
namespace Eric.Morrison.Harmony.Melody
{
    public partial class MelodyGenerator
    {
        ...
        public class DirectionChangingEventArgs : EventArgs
        {
            ...
            public MelodyGenerator MelodyGenerator { get; set; }
            public DirectionChangingEventArgs(MelodyGenerator mg, DirectionEnum current, DirectionEnum next)
            {
                this.MelodyGenerator = mg;
        ...
        public class ChordChangingEventArgs : EventArgs
        {
            ...
            public MelodyGenerator MelodyGenerator { get; set; }
            public ChordChangingEventArgs(MelodyGenerator mg, Chord current, Chord next)
            {
                this.MelodyGenerator = mg;
                this.Current = current;
                this.Next = next;
        ...
        public class NoteChangingEventArgs : EventArgs
        {
            ...
            public MelodyGenerator Arpeggiator { get; set; }
            public NoteChangingEventArgs(MelodyGenerator arp, Note current, Note next)
            {
        ...
        public class MelodyContextChangingEventArgs : EventArgs
        {
            public MelodyGeneratorChordContext Current { get; set; }
            public MelodyGeneratorChordContext Next { get; set; }
            public MelodyGenerator Arpeggiator { get; set; }
            public MelodyContextChangingEventArgs(MelodyGenerator arp, MelodyGeneratorChordContext current, MelodyGeneratorChordContext next)
            {
                this.Arpeggiator = arp;
                this.Current = current;
                this.Next = next;
        ...
        #region Events
        public event EventHandler<MelodyGenerator> Starting;
        public event EventHandler<MelodyGenerator> Started;

        public event EventHandler<MelodyGenerator> MeasureChanging;
        public event EventHandler<MelodyGenerator> MeasureChanged;

        public event EventHandler<ChordChangingEventArgs> ChordChanging;
        public event EventHandler<MelodyGenerator> ChordChanged;

        public event EventHandler<DirectionChangingEventArgs> DirectionChanging;
        public event EventHandler<MelodyGenerator> DirectionChanged;

        public event EventHandler<NoteChangingEventArgs> NoteChanging;
        public event EventHandler<MelodyGenerator> NoteChanged;

        public event EventHandler<MelodyGenerator> Ending;
        public event EventHandler<MelodyGenerator> Ended;
        ...
        Chord _CurrentChord;
        MelodyGeneratorChordContext _CurrentContext;
        int _CurrentBeat;
        int _CurrentMeasure;
        ...
        MelodyGeneratorChordContext CurrentContext
        {
        ...
        List<MelodyGeneratorChordContext> ChordContexts { get; set; } = new List<MelodyGeneratorChordContext>();

        bool UntilPatternRepeats { get; set; } = false;
        #endregion

        #region Construction
        public MelodyGenerator(IEnumerable<MelodyGeneratorChordContext> contexts, DirectionEnum direction,
NoteRange noteRange, int beatsPerBar, Note startingNote = null)
        {
            ...
            this.ChordContexts = new List<MelodyGeneratorChordContext>(contexts);
        ...
        public MelodyGenerator(IEnumerable<MelodyGeneratorChordContext> contexts, 
        ...
        public MelodyGenerator(DirectionEnum direction,
NoteRange noteRange, int beatsPerBar, Note startingNote = null)
        {
            this.Direction = direction;
            this.CurrentNote = startingNote;
        ...
        public MelodyGenerator Add(MelodyGeneratorChordContext ctx)
        {
        ...
        public MelodyClosestNoteContext ClosestNoteContext { get; set; }
        public void Arpeggiate()
        {
            this.ClosestNoteContext = new MelodyClosestNoteContext(this);
...

            {
                this.OnStarting();
                this.OnDirectionChanged();
                //this.OnMelodyGeneratorContextChanging(null, this._CurrentContext);
                //this.OnMelodyGeneratorContextChanged();
                this.OnStarted();
                ...
                foreach (var ctx in this.ChordContexts)
                {
                    ...
                    //for (int i = 0; i < noteCount; ++i, --noteCount)
                    {
                        ...
                        else
                        {
                            ...
                            var closestNoteCtx = new Chord.MelodyClosestNoteContext(
                                this.CurrentChord,
                                this.CurrentNote,
                                this.Direction);
