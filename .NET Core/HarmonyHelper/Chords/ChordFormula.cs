...
{
    public class ChordFormula : ClassBase, IEquatable<ChordFormula>, IComparable<ChordFormula>, INoteNameNormalizer, INoteNameContainer, IHasRootNoteName, IChordFormula
    {
        ...
        {
            var result = this.NoteNames.Contains(note);
            return result;
        }
        ...
        public static int Compare(ChordFormula a, ChordFormula b)
        {
            ...
            if (a.Equals(ChordFormula.Empty) || b.Equals(ChordFormula.Empty))
                return 0;
